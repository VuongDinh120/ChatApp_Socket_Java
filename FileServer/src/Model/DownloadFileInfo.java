...
public class DownloadFileInfo implements Serializable {
    ...
    public DownloadFileInfo(String destinationDirectory, String sourceDirectory, String filename, long fileSize, int piecesOfFile, int lastByteLength, String status) {
